...
public final class ActivitySettingBinding implements ViewBinding {
  ...
  private ActivitySettingBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnDeactivate,
      @NonNull Button btnSignOut, @NonNull TextView textView, @NonNull TextView textView2,
      @NonNull TextView textView3, @NonNull TextView textView4, @NonNull TextView textView5,
      @NonNull TextView textView6, @NonNull TextView tvUserEmail) {
  ...
  public static ActivitySettingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySettingBinding((ConstraintLayout) rootView, btnDeactivate, btnSignOut,
          textView, textView2, textView3, textView4, textView5, textView6, tvUserEmail);
    }

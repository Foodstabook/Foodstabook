...
fun ProfileScreen(
    ...
    var uid = user_profile.currentUser?.uid.toString()
    ...
    database.child(uid).get().addOnSuccessListener {
        ...
        if (it.exists()) {
            ...
            firstName = it.child("firstname").value as String
            lastName = it.child("lastname").value as String
    ...
    Column(
        ...
        Row(
            ...
            OutlinedTextField(
                value = lastName,
                onValueChange = { lastName.take(20) },
        ...
        Column(
            ...
            Card(
                ...
                Image(
                    ...
                    modifier = Modifier
                        .wrapContentSize()
                        .clickable { launcher.launch("drawable/*") },
